...
export function TherapistLoginForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000"}/therapist/login`, {
                method: "POST",
                headers: {
    ...
    return (
        <Card>
            <CardHeader>
                <h2 className="text-xl font-semibold">Therapist Sign In</h2>
            </CardHeader>
            <form onSubmit={handleSubmit}>
                ...
                <CardFooter className="flex flex-col gap-4 mt-4">
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                        ...
                        <Link href="/therapist/signup" className="text-primary hover:underline">
                            Register here
                        </Link>
                    </p>
                </CardFooter>
